...
void main() {
  ...
  test('deve manter-se na página quando não conseguir postar a doação.',
      () async {
    // arrange
    store.description = tDonation.description;
    store.beneficiaryId = tDonation.beneficiaryId;
  ...
  test('deve alterar a imagem quando for selecionada uma foto da câmera.',
      () async {
    // arrange
  ...
  test('deve manter a imagem quando não for selecionada uma foto da câmera.',
      () async {
    // arrange
    store.image = tFile;
  ...
  test('deve alterar a imagem quando for selecionada uma foto da galeria.',
      () async {
    // arrange
  ...
  test('deve manter a imagem quando não for selecionada uma foto da galeria.',
      () async {
    // arrange
    store.image = tFile;
