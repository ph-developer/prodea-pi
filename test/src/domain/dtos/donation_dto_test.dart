...
void main() {
  ...
  group('isExpired', () {
    test(
      'deve retornar que a doação está expirada.',
      () {
        // act
    ...
    test(
      'deve retornar que a doação não está expirada.',
      () {
        // arrange
  ...
  group('status', () {
    test(
      'deve retornar o status de cancelado.',
      () {
        // arrange
        final model = tModel.copyWith(
          cancellation: 'Teste',
    ...
    test(
      'deve retornar o status de entregue.',
      () {
        // arrange
        final model = tModel.copyWith(
          isDelivered: true,
    ...
    test(
      'deve retornar o status de validade expirada.',
      () {
        // arrange
        final model = tModel.copyWith(
          expiration: '01/01/2000',
    ...
    test(
      'deve retornar o status de aguardando interessados.',
      () {
        // arrange
        final model = tModel.copyWith(
          expiration: '01/01/5000',
    ...
    test(
      'deve retornar o status de aguardando retirada.',
      () {
        // arrange
        final model = tModel.copyWith(
          expiration: '01/01/5000',
