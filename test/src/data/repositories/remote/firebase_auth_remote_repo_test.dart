...
void main() {
  ...
  group('login', () {
    test(
      'deve retornar o id do usuário quando o login for bem sucedido.',
      () async {
        // arrange
    ...
    test(
      'deve disparar uma LoginFailure quando o usuário estiver bloqueado.',
      () {
        // arrange
        when(() => authMock.signInWithEmailAndPassword(
              email: any(named: 'email'),
    ...
    test(
      'deve disparar uma LoginFailure quando o email for inválido.',
      () {
        // arrange
        when(() => authMock.signInWithEmailAndPassword(
              email: any(named: 'email'),
    ...
    test(
      'deve disparar uma LoginFailure quando o usuário não for encontrado.',
      () {
        // arrange
        when(() => authMock.signInWithEmailAndPassword(
              email: any(named: 'email'),
    ...
    test(
      'deve disparar uma LoginFailure quando a senha estiver incorreta.',
      () {
        // arrange
        when(() => authMock.signInWithEmailAndPassword(
              email: any(named: 'email'),
    ...
    test(
      'deve disparar uma LoginFailure quando o login retornar null.',
      () {
        // arrange
        when(() => authMock.signInWithEmailAndPassword(
              email: any(named: 'email'),
    ...
    test(
      'deve disparar uma LoginFailure quando ocorrer um erro inesperado.',
      () {
        // arrange
        when(() => authMock.signInWithEmailAndPassword(
              email: any(named: 'email'),
  ...
  group('register', () {
    test(
      'deve retornar o id do usuário quando o registro for bem sucedido.',
      () async {
        // arrange
    ...
    test(
      'deve disparar uma RegisterFailure quando o email estiver em uso.',
      () {
        // arrange
        when(() => authMock.createUserWithEmailAndPassword(
              email: any(named: 'email'),
    ...
    test(
      'deve disparar uma RegisterFailure quando o email for inválido.',
      () {
        // arrange
        when(() => authMock.createUserWithEmailAndPassword(
              email: any(named: 'email'),
    ...
    test(
      'deve disparar uma RegisterFailure quando a senha for fraca.',
      () {
        // arrange
        when(() => authMock.createUserWithEmailAndPassword(
              email: any(named: 'email'),
    ...
    test(
      'deve disparar uma RegisterFailure quando o registro retornar null.',
      () {
        // arrange
        when(() => authMock.createUserWithEmailAndPassword(
              email: any(named: 'email'),
    ...
    test(
      'deve disparar uma RegisterFailure quando ocorrer um erro inesperado.',
      () {
        // arrange
        when(() => authMock.createUserWithEmailAndPassword(
              email: any(named: 'email'),
  ...
  group('sendPasswordResetEmail', () {
    test(
      ...
      () async {
        ...
        // act
        final result = await firebaseAuthRemoteRepo
            .sendPasswordResetEmail('test@test.dev');
        // assert
    ...
    test(
      'deve disparar uma PasswordResetFailure quando o email for inválido.',
      () {
        // arrange
        when(() => authMock.sendPasswordResetEmail(
              email: any(named: 'email'),
  ...
  group('logout', () {
    test(
      'deve retornar true quando o logout for bem sucedido.',
      () async {
        // arrange
    ...
    test(
      'deve disparar uma LogoutFailure quando ocorrer um erro.',
      () {
        // arrange
  ...
  group('getCurrentUserId', () {
    test(
      'deve retornar o id do usuário se ele estiver autenticado.',
      () async {
        // arrange
    ...
    test(
      'deve retornar null quando o usuário não estiver autenticado.',
      () async {
        // arrange
        when(() => authMock.currentUser).thenAnswer((_) => null);
        when(authMock.authStateChanges)
  ...
  group('currentUserIdChanged', () {
    test(
      'deve retornar o id do usuário quando efetuar o login.',
      () {
        // arrange
        when(authMock.authStateChanges)
            .thenAnswer((_) => Stream.fromIterable([userMock]));
    ...
    test(
      'deve retornar null quando o usuário efetuar o logout.',
      () {
        // arrange
        when(authMock.authStateChanges)
            .thenAnswer((_) => Stream.fromIterable([null]));
