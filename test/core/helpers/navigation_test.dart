...
void main() {
  ...
  test('deve navegar para outra rota sem remover histórico.', () async {
    // arrange
  ...
  test('deve navegar para outra rota e remover histórico.', () {
    // act
  ...
  test('deve navegar para a rota anterior.', () {
    // act
  ...
  test('deve emitir a rota quando ocorrer uma navegação.', () {
    // act
